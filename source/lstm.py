# -*- coding: utf-8 -*-
"""
Created on Sat Oct 10 13:34:41 2020
...
"""
Split datasets: Window of 3 input steps
Use "lstm" for LSTM (and LSTM modified models) predictions
Returns sclaer used for scaling the output variables
"""
X_train, X_test, y_train, y_test, output_scaler = make_datasets(data_cache, model_name = 'lstm')

"""
Model defenition: replace _model_ with (lstm or bi_lstm or gru_lstm), everywhere from the compiler
...
result = nn_model_compile(_model_, X_train, y_train)

"""
Run model
Inverse transform test targets and predictions
"""
_model_.evaluate(X_test, y_test)
